templates.holidaysCollectionTpl = _.template([
    '<div class="panel panel-default">',
        ...
        '<table class="table holidays-list">',
            '<th class="name-header">Name<i class="sort-flag glyphicon glyphicon-triangle-bottom"></i></th>',
            '<th class="date-header">Date<i class="sort-flag glyphicon"></i></th>',
            '<th class="location-header">Location<i class="sort-flag glyphicon"></i></th>',
        '</table>',
    '</div>',
    '<nav>',
    '</nav>'
