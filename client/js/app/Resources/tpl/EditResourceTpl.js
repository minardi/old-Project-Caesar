			...
			'<div class="modal-body clearfix">',
				...
				'<div class="form-group hideData <%= classForHide %>" class="col-xs-4">',
					...
					'<div class="input-group" id="datetimepickerStart">',
						'<input type="text" class="form-control date holidayDate input-group-addon" name = "dateStart" id = "dateStart" value="<%= dateStart %>">',
				...
				'<div class="form-group hideData <%= classForHide %>" class="col-xs-4">',
					...
					'<div class="input-group" id="datetimepickerFinish">',
						'<input type="text" class="form-control date holidayDate input-group-addon" name = "dateFinish" id = "dateFinish" value="<%= dateFinish %>">',
						'<span class="input-group-addon">',
							'<span class="glyphicon glyphicon-calendar"></span>',
						'</span>',
					'</div>',
				...
				'<div class="form-group checkbox">',
					'<label>',
						'<input type="checkbox" name="resourseCheckbox" data-size="mini" data-on-text="Yes" data-off-text="No" data-off-color="warning"',
							'<% if (useInSchedule) { %>',
								'checked="<%= "checked" %>"',
							'<% } %> > use in schedule',
					'</label>',
